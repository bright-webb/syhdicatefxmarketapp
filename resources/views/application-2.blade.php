  ...
  <!-- ===================================
            ...
            <section class="account-section padding-20" style="background: white">
                <div class="display-title">
                    <span class="name_step">Step 2 of 4</span>
                    <h1 class="text-dark">Apply</h1>

                </div>
                <div class="content__form margin-t-40">
                    <form method="get" action="/application-3">
                        ...
                        <div class="form-group">
                            ...
                            <select name="category" class="form-control">
                                ...
                                <option value=" currency pair"> Currency Pair</option>
...
<select class="form-control" id="country" name="country" >
    ...
    <option value="Zimbabwe">Zimbabwe</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" name="phone" class="form-control" placeholder='e. g. 000000000' required>
                        </div>
                        <div class="form-group">
